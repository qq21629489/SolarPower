...
### 模型訓練
* 輸入：50家的產(G)電/用(C)電，包含時間(年月日小時)
* 訓練資料：
   * 用7天的月、日、小時、產電(共7*24)，預測未來1天用電(modelC)
   * 用7天的月、日、小時、用電(共7*24)，預測未來1天產電(modelG)
* model：LSTM

### 交易策略
* 將預測結果相減(用電 - 產電)
   * 如果大於零代表用電量 > 產電量，需要買電，就以2.5元作為買價買入
   * 如果小於零代表用電量 < 產電量，可以賣電，就以3元作為賣價賣出
